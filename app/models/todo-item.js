...
export default DS.Model.extend({
  ...
  childTodos: DS.hasMany('todo-item', { inverse: 'todo-item' }),  //如果当前todo有子todo则这个属性指向子todo
  parentTodo: DS.belongsTo('todo-item', { inverse: 'todo-item' }),  //如果当前todo是子todo则这个属性指向自己的父todo
