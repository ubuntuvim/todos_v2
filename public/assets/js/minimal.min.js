...
//     //     $("#content-main").getNiceScroll().hide()
//     // });
//     // $("#mmenu").on("closed.mm", function() {
//     //     $("#content-main").getNiceScroll().show()
//     // });
...
//     $("#loader").delay(50000).fadeOut(300);
//     $(".mask").delay(80000).fadeOut(300, function() {
//         widthLess1024();
//         widthLess768()
//     })
// });

//  不知道是什么原因，原来的点击事件无法触发， 只能勇敢js函数调用触发
function closeOrCollapsLeftMenu() {
