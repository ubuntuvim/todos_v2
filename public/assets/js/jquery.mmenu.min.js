...
function(e) {
    function n(n, t, s) {
        ...
        return n = e.extend(!0, {},
        e[a].defaults, n),
        ("top" == n.position || "bottom" == n.position) && ("back" == n.zposition || "next" == n.zposition) && (e[a].deprecated('Using position "' + n.position + '" in combination with zposition "' + n.zposition + '"', 'zposition "front"'), n.zposition = "front"),
        n
    }
    function t(n) {
        return n = e.extend(!0, {},
        e[a].configuration, n),
        "string" != typeof n.pageSelector && (n.pageSelector = "> " + n.pageNodetype),
        n
    }
    function s() {
        r.$wndw = e(window),
        ...
        d.add("menu ismenu panel list subtitle selected label spacer current highest hidden page blocker modal background opened opening subopened subopen fullsubopen subclose"),
        d.umm = function(e) {
        ...
        u.add("toggle open opening opened close closing closed update setPage setSelected transitionend webkitTransitionEnd mousedown touchstart mouseup touchend scroll touchmove click keydown keyup resize"),
        r.$wndw.on(u.keydown,
        function(e) {
    ...
    function o(n, t) {
        ...
        return s.removeClass(d.highest).removeClass(d.current).not(n).not(o).addClass(d.hidden),
        n.hasClass(d.opened) ? o.addClass(d.highest).removeClass(d.opened).removeClass(d.subopened) : (n.addClass(d.highest), o.addClass(d.subopened)),
        n.removeClass(d.hidden).removeClass(d.subopened).addClass(d.current).addClass(d.opened),
        "open"
    }
    function i(e, n, t) {
        var s = !1,
    ...
    if (!e[a]) {
        ...
        e[a].prototype = {
            ...
            _openSetup: function() {
                ...
                "left" != this.opts.position && r.$html.addClass(d.mm(this.opts.position)),
                "back" != this.opts.zposition && r.$html.addClass(d.mm(this.opts.zposition)),
            ...
            close: function() {
                ...
                //     r.$html.removeClass(d.opened).removeClass(d.modal).removeClass(d.background).removeClass(d.mm(e.opts.position)).removeClass(d.mm(e.opts.zposition)),
                //     e.opts.classes && r.$html.removeClass(e.opts.classes),
                //     r.$wndw.off(u.resize).off(u.keydown),
            ...
            _bindCustomEvents: function() {
                var n = this;
                this.$menu.off(u.open + " " + u.close + " " + u.setPage + " " + u.update).on(u.open + " " + u.close + " " + u.setPage + " " + u.update,
                function(e) {
                    e.stopPropagation()
                }),
                this.$menu.on(u.open,
                ...
                t.off(u.toggle + " " + u.open + " " + u.close).on(u.toggle + " " + u.open + " " + u.close,
                function(e) {
                    e.stopPropagation()
                }),
                "horizontal" == this.direction ? t.on(u.open,
                function() {
                ...
                function() {
                    return e(this).parent().addClass(d.opened),
                    "open"
                }).on(u.close,
                function() {
                    return e(this).parent().removeClass(d.opened),
                    "close"
                })
            },
            _initBlocker: function() {
                var n = this;
                r.$blck || (r.$blck = e('<div id="' + d.blocker + '" />').appendTo(r.$body)),
                r.$blck.off(u.touchstart).on(u.touchstart,
                function(e) {
                    e.preventDefault(),
                    e.stopPropagation(),
            ...
            _initPage: function(n) {
                n || (n = e(this.conf.pageSelector, r.$body), n.length > 1 && (e[a].debug("Multiple nodes found for the page-node, all nodes are wrapped in one <" + this.conf.pageNodetype + ">."), n = n.wrapAll("<" + this.conf.pageNodetype + " />").parent())),
                n.addClass(d.page),
                r.$page = n
            },
            _initMenu: function() {
                ...
                this.$menu.prependTo("body").addClass(d.menu),
                ...
                "left" != this.opts.position && this.$menu.addClass(d.mm(this.opts.position)),
                "back" != this.opts.zposition && this.$menu.addClass(d.mm(this.opts.zposition))
            },
            _initPanles: function() {
                var n = this;
                this.__refactorClass(e("." + this.conf.listClass, this.$menu), "list"),
                this.opts.isMenu && e("ul, ol", this.$menu).not(".mm-nolist").addClass(d.list);
                var t = e("." + d.list + " > li", this.$menu);
                this.__refactorClass(t.filter("." + this.conf.selectedClass), "selected"),
                this.__refactorClass(t.filter("." + this.conf.labelClass), "label"),
                this.__refactorClass(t.filter("." + this.conf.spacerClass), "spacer"),
                t.off(u.setSelected).on(u.setSelected,
                function(n, s) {
                    n.stopPropagation(),
                ...
                this.$menu.children().filter(this.conf.panelNodetype).add(this.$menu.find("." + d.list).children().children().filter(this.conf.panelNodetype)).addClass(d.panel);
                ...
                s.find("." + d.panel).each(function() {
                    ...
                    if (t.data(c.parent, o), o.parent().is("." + d.list)) {
                        ...
                        "horizontal" == n.direction && s.prepend('<li class="' + d.subtitle + '"><a class="' + d.subclose + '" href="#' + a.attr("id") + '">' + i.text() + "</a></li>")
                    }
                });
                ...
                if (s.each(function() {
                    var t = e(this),
                    s = t.attr("id");
                    e('a[href="#' + s + '"]', n.$menu).off(u.click).on(u.click,
                    function(e) {
                        e.preventDefault(),
                        t.trigger(o)
                    })
                ...
                "horizontal" == this.direction && s.find("." + d.panel).appendTo(this.$menu)
            },
            _initLinks: function() {
                var n = this;
                e("." + d.list + " > li > a", this.$menu).not("." + d.subopen).not("." + d.subclose).not('[rel="external"]').not('[target="_blank"]').off(u.click).on(u.click,
                function(t) {
                    var s = e(this),
                    o = s.attr("href");
                    ...
                    i && t.preventDefault(),
                    n.__valueOrFn(n.opts.onClick.blockUI, s, !i) && r.$html.addClass(d.blocking),
                    n.__valueOrFn(n.opts.onClick.close, s, i) && n.$menu.triggerHandler(u.close)
                })
            },
            _initOpenClose: function() {
                var n = this,
                t = this.$menu.attr("id");
                t && t.length && (this.conf.clone && (t = d.umm(t)), e('a[href="#' + t + '"]').off(u.click).on(u.click,
                function(e) {
                    e.preventDefault(),
                    n.$menu.trigger(u.open)
                }));
                var t = r.$page.attr("id");
                t && t.length && e('a[href="#' + t + '"]').off(u.click).on(u.click,
                function(e) {
                    e.preventDefault(),
                    n.$menu.trigger(u.close)
                })
            },
